...
function Solicitud_NoCliente_Page2(){
  ...
  return (
    <div className='mx-auto'>
      ...
      <div className='pl-8'>
        <div className='pt-8'>
          <h2 className="text-2xl font-semibold mb-2">Bienvenido '{state.razonSocial}'</h2>
          <p><span className="font-medium">RUC:</span> {state.ruc}</p>
...
export default Solicitud_NoCliente_Page2;